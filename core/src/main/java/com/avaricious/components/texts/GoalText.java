...
public class GoalText extends FabledText {
    protected GoalText(List<TextureRegion> letterTextures, List<TextureRegion> letterShadowTextures, Vector2 startingPos, float sizeRatio, float spacing, ZIndex zIndex) {
