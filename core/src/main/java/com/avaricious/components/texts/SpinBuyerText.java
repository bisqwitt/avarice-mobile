...
public class SpinBuyerText extends FabledText {
    ...
    public SpinBuyerText() {
        super(
            new FabledWord(
                ...
                ), new Vector2(1f, 14f), SIZE_RATIO, SPACING, Z_INDEX
            ),
            new FabledWord(
                Arrays.asList(
                ...
                ), new Vector2(2.75f, 14f), SIZE_RATIO, SPACING, Z_INDEX
            )
        );
    }
