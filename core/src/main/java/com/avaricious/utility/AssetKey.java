...
public enum AssetKey {
    ...
    CHERRY("cherry"),
    CHERRY_SHADOW("cherry-shadow"),
    CHERRY_WHITE("cherry-white"),
    CLOVER("clover"),
    CLOVER_SHADOW("clover-shadow"),
    CLOVER_WHITE("clover-white"),
    BELL("bell"),
    BELL_SHADOW("bell-shadow"),
    BELL_WHITE("bell-white"),
    IRON("iron"),
    IRON_SHADOW("iron-shadow"),
    IRON_WHITE("iron-white"),
    DIAMOND("diamond"),
    DIAMOND_SHADOW("diamond-shadow"),
    DIAMOND_WHITE("diamond-white"),
    SEVEN("seven"),
    SEVEN_SHADOW("seven-shadow"),
    SEVEN_WHITE("seven-white"),
    SLOT_BOX("slotBox"),
    ...
    SOLD_TXT("sold-txt"),
    SOLD_TXT_SHADOW("sold-txt-shadow"),
    CLAIMED_TXT("claimed-txt"),
    CLAIMED_TXT_SHADOW("claimed-txt-shadow"),
    PRICE_BOX("price-box"),
    ...
    RARITY_BOX_COMMON("rarity-box-common"),
    RARITY_BOX_UNCOMMON("rarity-box-uncommon"),
    RARITY_BOX_RARE("rarity-box-rare"),
    RARITY_BOX_EPIC("rarity-box-epic"),
    ...
    E_BIG("e-big"),
    E_BIG_SHADOW("e-big-shadow"),
    W_BIG("w-big"),
    W_BIG_SHADOW("w-big-shadow"),
    G("g"),
    G_SHADOW("g-shadow"),
    F("f"),
    F_SHADOW("f-shadow"),
